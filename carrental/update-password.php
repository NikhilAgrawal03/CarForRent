...
<title>Car For Rent - Update Password</title>
<!--Bootstrap -->
...
<section class="user_profile inner_pages">
  <div class="container">
      ...
      <div class="dealer_info">
        <h5 style="font-size: 38px; line-height: 32px; border-color: black;border-bottom: 3px;"><?php echo htmlentities($result->FullName);?></h5>
